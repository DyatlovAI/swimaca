              ...
              GridView.count(
                ...
                children: [
                  _buildStrokeCard(
                    ...
                    'Смотрите видео',
                    'assets/images/i.png',
                    'https://www.youtube.com/watch?v=1d3_EiyJbys',
                  ),
                  _buildStrokeCard(
                    'Урок 2: Кроль',
                    'Смотрите видео',
                    'assets/images/i2.png',
                    'https://www.youtube.com/watch?v=OGRL5Ffj8YE',
                  ),
                  _buildStrokeCard(
                    'Урок 3: Брасс',
                    'Смотрите видео',
                    'assets/images/i3.png',
                    'https://www.youtube.com/watch?v=xVtntahYQ7M',
                  ),
                  _buildStrokeCard(
                    'Урок 4: Спина',
                    'Смотрите видео',
                    'assets/images/i4.png',
                    'https://www.youtube.com/watch?v=3E4C6U4cSro',
                  ),
                ],
              ),
